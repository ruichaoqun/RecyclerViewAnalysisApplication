...
import com.youdeyi.recyclerviewanalysisapplication.R;
import com.youdeyi.recyclerviewanalysisapplication.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (mLayout.isAutoMeasureEnabled()) {
            ...
            //如果是指定的宽高，在defaultOnMeasure方法中已经setMeasuredDimension设置了宽高，不再测量子View再确定recycler宽高了
            ...
            // consistency
            //设置宽高，wrap以及excatly都有精确的宽高值
            mLayout.setMeasureSpecs(widthSpec, heightSpec);
            //开始测量，测量是通过layout来确定的
            mState.mIsMeasuring = true;
            // 真正开始执行layout
            dispatchLayoutStep2();

            // now we can get the width and height from the children.
            //根据child来获取recyclerView的宽高
